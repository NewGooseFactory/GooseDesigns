...
![destructive_command_guard — terminal-dark](./01-destructive-command-guard.png)
...
![background-agents — editorial](./02-background-agents.png)
...
![hallmark — bauhaus](./03-hallmark.png)
