...
![DesktopCommanderMCP — terminal-dark](./01-DesktopCommanderMCP.png)
...
![TencentDB-Agent-Memory — hud](./02-TencentDB-Agent-Memory.png)
...
![superpowers — editorial](./03-superpowers.png)
